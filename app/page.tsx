        ...
        <div className="container flex h-auto py-2 md:py-0 md:h-20 items-center justify-between">
          <div className="flex items-center gap-2">
            <Link href="/" className="flex items-center">
              <Image
                ...
                width={80}
                height={80}
                className={`h-40 w-auto sm:h-32 md:h-32 transition-all duration-500 ${
                  isLoaded ? "bounce-in" : "opacity-0"
                }`}
                priority
              />
              <span
                className={`hidden sm:inline-block ml-2 text-2xl md:text-3xl lg:text-4xl team-name transition-all duration-500 ${
          ...
          <div className="flex items-center gap-4">
            <Button
              ...
              asChild
            >
              <Link href="#contato">Junte-se a nós</Link>
            </Button>
            <button
              ...
              <div className="flex flex-col justify-center space-y-4 text-center lg:text-left">
                <div className="space-y-2">
                  ...
                  <p className="text-sm sm:text-base md:text-lg text-muted-foreground">
                    Centro de formação de cidadãos e atletas de voleibol,
                    fundada em 2014.
                  </p>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-6">
                ...
                <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-[900px] mx-auto">
                  Vale destacar também, o compromisso na formação de pessoas,
                  com princípios e valores tais como: honestidade, ética e
                  espírito de equipe. Pois os atletas não são referências
                  somente dentro das quadras, mas também fora delas.
                </p>
              </div>
              <div className="mx-auto grid max-w-5xl items-center gap-6 py-8 md:py-12 sm:grid-cols-2 lg:grid-cols-3">
                <div className="grid gap-1">
                  ...
                  <p className="text-sm sm:text-base text-muted-foreground">
                    Formar atletas de excelência e promover o vôlei como
                ...
                <div className="grid gap-1">
                  ...
                  <p className="text-sm sm:text-base text-muted-foreground">
                    Ser referência nacional na formação de atletas e na promoção
                    do vôlei em Brasília.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <div className="mx-auto grid max-w-5xl gap-4 md:gap-8 py-8 md:py-12 lg:grid-cols-1">
                {[
                  {
                    date: "15/05/2025",
                    opponent: "Brasília Vôlei",
                    location: "Ginásio do Cruzeiro",
                    time: "19:00",
                  },
                  {
                    date: "22/05/2025",
                    opponent: "Taguatinga Vôlei",
                    location: "Ginásio da Asa Norte",
                    time: "20:00",
                  },
                  {
                    date: "29/05/2025",
                  ...
                  {
                    date: "05/06/2025",
                    opponent: "Águas Claras VC",
                    location: "Ginásio da Asa Sul",
                    time: "18:30",
                  },
                ].map((game, index) => (
                  <div
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-6">
                ...
                <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-[900px] mx-auto pt-4">
                  Quer saber mais sobre nossa equipe ou tem interesse em fazer
                  parte do Mais Vôlei Brasília? Entre em contato conosco!
                </p>
              </div>
              <div className="mx-auto grid max-w-5xl gap-8 py-8 md:py-12 md:grid-cols-2">
                <div className="flex flex-col space-y-4">
                  ...
                  <div className="flex items-center gap-2">
                    <MapPin className="h-4 w-4 sm:h-5 sm:w-5 text-secondary" />
                    <span className="text-sm sm:text-base">
                      Ginásio do Cruzeiro, Brasília - DF
                    </span>
                  </div>
